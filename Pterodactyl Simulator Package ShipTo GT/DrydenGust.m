...
%   The DrydenGust Function accomidates variations in Altitude,
...
persistent Win GOn GTo Dis Rng NDS Prb TOn Alt Tur Mil Env
...
if (TOn == 1)
    ...
    if (counter == 1)
        randdev = 1;
        randset(1,1) = randdev*randn;
        randset(2,1) = randdev*randn;
        randset(3,1) = randdev*randn;
    end     
